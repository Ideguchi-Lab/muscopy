...
and reconstruct it using IDT. We then compare the result to the original to see
for what sizes and what refractive index IDT is most effective
"""
"""ODT Comparison
...
r_values = jnp.linspace(0.5, 5, 20)
...
def compute_error(n_recon: Array, gt_r_index: Array) -> float:
    """Finds the error between the Ground Truth image and IDT Reconstruction
